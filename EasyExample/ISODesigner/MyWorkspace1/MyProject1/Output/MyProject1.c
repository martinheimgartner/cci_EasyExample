...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(WorkingSet_0), TYPEID_WORKSET, COLOR(187), 1, ID(DataMask_Home), 1, 0, 2,
		...
		'e', 'n',
		'd', 'e',
	ID(Macro_zurhauptseite), TYPEID_MACRO, WORD(8),
		CMD_CHANGE_ACTIVE_MASK, ID(WorkingSet_0), ID(DataMask_Home), 0xFF, 0xFF, 0xFF,
	ID(Macro_zurseite1), TYPEID_MACRO, WORD(8),
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 8, 0, 
		...
		XYREF(Button_seite1, 100, 414),
	ID(DataMask_seite2), TYPEID_DATAMASK, COLOR(230), ID(ID_NULL), 1, 0, 
		XYREF(Button_zurueck, 104, 372),
	...
	ID(Button_zurueck), TYPEID_BUTTON, WORD(163), WORD(62), 2, 0, 1, 0, 1, 1, 
		XYREF(OutputString_zurueck, -11, 16),
		MACRO(EV_KEYRELEASE, Macro_zurhauptseite),
	ID(Button_seite1), TYPEID_BUTTON, WORD(149), WORD(54), 2, 0, 1, 0, 1, 1, 
		XYREF(OutputString_seite, -4, 13),
		MACRO(EV_KEYRELEASE, Macro_zurseite1),
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(80), WORD(40), COLOR_WHITE, ID(FontAttributes_Button), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_zurueck), TYPEID_OUTSTR, WORD(167), WORD(20), COLOR_GREEN, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 1, WORD(6), 'Z', 'u', 'r', 'ü', 'c', 'k', 0,
	ID(OutputString_seite), TYPEID_OUTSTR, WORD(149), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
	...
	ID(FontAttributes_23000), TYPEID_FONTATTR, COLOR_BLACK, 3, 0, 132, 0, 
